...
static PyMethodDef kmeansMethods[] = {
    {"fit",                                                                                                                                                                                /* the Python method name that will be used */
     ...
     PyDoc_STR(" the kmeanssp algorithm expects args: epsilon, iter, k, n, d, vectorlist = [vector, cluster_of_vector], clusterlist  = [size_of_cluster, vector_of_sums, mean_vector]")}, /*  The docstring for the function */
